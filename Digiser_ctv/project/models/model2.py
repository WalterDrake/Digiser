...
class Birth_Certificate_Document(models.Model):
    ...
    noiDangKy = models.CharField(
        max_length=100, default='', verbose_name='Nơi Đăng Ký', blank=True)
    nguoiKy = models.CharField(
        max_length=20, default='', verbose_name='Người Ký', blank=True)
    chucVuNguoiKy = models.CharField(
        max_length=30, default='', verbose_name="Chức Vụ Người Ký", blank=True)
    nguoiThucHien = models.CharField(
        max_length=50, default='', verbose_name="Người Thực Hiện", blank=True)
    ghiChu = models.CharField(
        max_length=20, default='', verbose_name="Ghi Chú", blank=True)

    # Thông tin về người được đăng ký khai sinh (11 trường)
    nksHoTen = models.CharField(
        max_length=30, default='', verbose_name='Họ Tên (Người Khai Sinh)', blank=True)
    ...
    nksNgaySinh = models.CharField(
        max_length=12, default='', verbose_name='Ngày Sinh (Người Khai Sinh)', blank=True)
    nksNgaySinhBangChu = models.CharField(
        max_length=100, default='', verbose_name='Ngày Sinh Bằng Chữ (Người Khai Sinh)', blank=True)
    nksNoiSinh = models.CharField(
        max_length=100, default='', verbose_name='Nơi Sinh Chi Tiết (Người Khai Sinh)', blank=True)
    nksNoiSinhDDHC = models.CharField(
        max_length=50, default='', verbose_name='Nơi Sinh Bằng Địa Danh Hành Chính (Người Khai Sinh)', blank=True)
    nksQueQuan = models.CharField(
        max_length=100, default='', verbose_name='Quê Quán (Người Khai Sinh)', blank=True)
    nksDanToc = models.CharField(max_length=26, default='', choices=Options._DANTOC_LIST,
    ...
    nksQuocTichKhac = models.CharField(
        max_length=65, default='', verbose_name='Quốc Tịch Khác (Người Khai Sinh)', blank=True)
    nksLoaiKhaiSinh = models.CharField(max_length=1, default='', verbose_name='Loại Khai Sinh (Người Khai Sinh)',
    ...
    nksMatTich = models.CharField(
        max_length=10, default='', verbose_name='Mất Tích (Người Khai Sinh)', blank=True)
    nksMatTichNgayGhiChuTuyenBo = models.CharField(
        max_length=10, default='', verbose_name='Ngày Ghi Chú Tuyên Bố Mất Tích (Người Khai Sinh)', blank=True)
    nksMatTichCanCuTuyenBo = models.CharField(
        max_length=10, default='', verbose_name='Căn Cứ Tuyên Bố Mất Tích (Người Khai Sinh)', blank=True)
    nksMatTichNgayGhiChuHuyTuyenBo = models.CharField(
        max_length=10, default='', verbose_name='Ngày Ghi Chú Hủy Tuyên Bố Mất Tích (Người Khai Sinh)', blank=True)
    nksMatTichCanCuHuyTuyenBo = models.CharField(
        max_length=10, default='', verbose_name='Căn Cứ Hủy Tuyên Bố Mất Tích (Người Khai Sinh)', blank=True)

    # Thông tin hạn chế năng lực hành vi của người khai sinh (5 trường)
    nksHanCheNangLucHanhVi = models.CharField(
        max_length=10, default='', verbose_name='Hạn Chế Năng Lực Hành Vi (Người Khai Sinh)', blank=True)
    nksHanCheNangLucHanhViNgayGhiChuTuyenBo = models.CharField(
        max_length=10, default='', verbose_name='Ngày Ghi Chú Tuyên Bố Hạn Chế Năng Lực Hành Vi (Người Khai Sinh)', blank=True)
    nksHanCheNangLucHanhViCanCuTuyenBo = models.CharField(
        max_length=10, default='', verbose_name='Căn Cứ Tuyên Bố Hạn Chế Năng Lực Hành Vi (Người Khai Sinh)', blank=True)
    nksHanCheNangLucHanhViNgayGhiChuHuyTuyenBo = models.CharField(
        max_length=10, default='', verbose_name='Ngày Ghi Chú Hủy Tuyên Bố Hạn Chế Năng Lực Hành Vi (Người Khai Sinh)', blank=True)
    nksHanCheNangLucHanhViNgayCanCuHuyTuyenBo = models.CharField(
        max_length=10, default='', verbose_name='Ngày Căn Cứ Hủy Tuyên Bố Hạn Chế Năng Lực Hành Vi (Người Khai Sinh)', blank=True)

    # Thông tin về mẹ của người khai sinh (9 trường)
    meHoTen = models.CharField(
        max_length=30, default='', verbose_name='Họ và Tên (Mẹ)', blank=True)
    meNgaySinh = models.CharField(
        max_length=12, default='', verbose_name='Ngày Sinh (Mẹ)', blank=True)
    meDanToc = models.CharField(max_length=26, choices=Options._DANTOC_LIST,
                                default='', verbose_name='Dân Tộc (Mẹ)', blank=True)
    meQuocTich = models.CharField(
        max_length=20, default='', verbose_name='Quốc Tịch (Mẹ)', blank=True)
    meQuocTichKhac = models.CharField(
        max_length=10, default='', verbose_name='Quốc Tịch Khác (Mẹ)', blank=True)
    meLoaiCuTru = models.CharField(max_length=1, choices=Options._RESIDENCE_TYPE,
                                   default='', verbose_name='Loại Cư Trú (Mẹ)', blank=True)
    meNoiCuTru = models.CharField(
        max_length=100, default='', verbose_name='Nơi Cư Trú (Mẹ)', blank=True)
    meLoaiGiayToTuyThan = models.CharField(
        max_length=1, choices=Options._IDENTIFICATION_TYPE, default='', verbose_name='Loại Giấy Tờ Tùy Thân (Mẹ)', blank=True)
    meSoGiayToTuyThan = models.CharField(
        max_length=12, default='', verbose_name='Số Giấy Tờ Tùy Thân (Mẹ)', blank=True)

    # Thông tin về cha của người khai sinh (9 trường)
    chaHoTen = models.CharField(
        max_length=30, default='', verbose_name='Họ Tên (Cha)', blank=True)
    chaNgaySinh = models.CharField(
        max_length=12, default='', verbose_name='Ngày Sinh (Cha)', blank=True)
    chaDanToc = models.CharField(max_length=26, choices=Options._DANTOC_LIST,
                                 default='', verbose_name='Dân Tộc (Cha)', blank=True)
    chaQuocTich = models.CharField(
        max_length=20, default='', verbose_name='Quốc Tịch (Cha)', blank=True)
    chaQuocTichKhac = models.CharField(
        max_length=20, default='', verbose_name='Quốc Tịch Khác (Cha)', blank=True)
    chaLoaiCuTru = models.CharField(
        max_length=1, default='', verbose_name='Loại Cư Trú (Cha)', blank=True)
    chaNoiCuTru = models.CharField(
        max_length=100, default='', verbose_name='Nơi Cư Trú (Cha)', blank=True)
    chaLoaiGiayToTuyThan = models.CharField(
        max_length=1, default='', verbose_name='Loại Giấy Tờ Tùy Thân (Cha)', blank=True)
    chaSoGiayToTuyThan = models.CharField(
        max_length=12, default='', verbose_name='Số Giấy Tờ Tùy Thân (Cha)', blank=True)

    # Thông tin về người đi khai - người yêu cầu (7 trường)
    nycHoTen = models.CharField(
        max_length=30, default='', verbose_name='Họ Tên (Người Yêu Cầu)', blank=True)
    nycQuanHe = models.CharField(
        max_length=10, default='', verbose_name='Quan Hệ (Người Yêu Cầu)', blank=True)
    nycLoaiGiayToTuyThan = models.CharField(max_length=1, choices=Options._IDENTIFICATION_TYPE,
                                            default='', verbose_name='Loại Giấy Tờ Tùy Thân (Người Yêu Cầu)', blank=True)
    nycGiayToKhac = models.CharField(
        max_length=20, default='', verbose_name='Giấy Tờ Khác (Người Yêu Cầu)', blank=True)
    nycSoGiayToTuyThan = models.CharField(
        max_length=12, default='', verbose_name='Số Giấy Tờ Tùy Thân (Người Yêu Cầu)', blank=True)
    nycNgayCapGiayToTuyThan = models.CharField(
        max_length=12, default='', verbose_name='Ngày Cấp Giấy Tờ Tùy Thân (Người Yêu Cầu)', blank=True)
    nycNoiCapGiayToTuyThan = models.CharField(
        max_length=100, default='', verbose_name='Nơi Cấp Giấy Tờ Tùy Thân (Người Yêu Cầu)', blank=True)

    # Thông tin đăng ký nước ngoài (4 trường)
    soDangKyNuocNgoai = models.CharField(
        max_length=12, default='', verbose_name="Số Đăng Ký Nước Ngoài", blank=True)
    ngayDangKyNuocNgoai = models.CharField(
        max_length=12, default='', verbose_name="Ngày Đăng Ký Nước Ngoài", blank=True)
    cqNuocNgoaiDaDangKy = models.CharField(
        max_length=30, default='', verbose_name="Cơ Quan Đăng Ký Nước Ngoài", blank=True)
